...
export const DATA = {
  ...
  work: [
    ...
    {
      company: "Tridify",
      href: "https://tridify.com",
      badges: ["Remote"],
      location: "Helsinki, Finland",
      title: "UX/UI Designer & Consultant",
      logoUrl: "/tridify-logo.svg",
      start: "May 2023",
      end: "September 2023",
      description:
        "Redesigned Tridify's BIM/XR app UI, simplifying the workflow for architects and construction professionals. Created and implemented a design system in Figma. Developed user journeys, wireframes, and prototypes for a major feature launch. Conducted usability testing and leveraged data to improve the product experience.",
    },
    {
      company: "Joustava.work",
      href: "https://joustava.work",
      badges: ["Part-time"],
      location: "Helsinki, Finland",
      title: "Lead UX/UI Designer",
      logoUrl: "/joustava-logo.svg",
      start: "October 2023",
      end: "Present",
      description:
        "Responsible for the UX/UI of Truster's mobile application, ERP, and website. Contributed to scaling the business from 6,000 to 35,000 users. Designed a feature that increased extra service requests, generating additional revenue. Developed a modular design system in Figma to streamline workflows. Redesigned ERP views, leading to improved processing efficiency.",
